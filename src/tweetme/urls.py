...
#     url(r'^', include('account.urls', namespace='profiles')),
#     url(r'^api/tweet/', include('tweets.api.urls', namespace='tweet-api')),
#      url(r'^register/$', UserRegisterView.as_view(), name='register'), 
#      url(r'^', include('django.contrib.auth.urls')),
#     url(r'^api/', include('account.api.urls', namespace='profile-api')),
...
urlpatterns = [
    ...
    url(r'^api/search/$', SearchTweetAPIView.as_view(), name='search-api'), 
    url(r'^api/tweet/', include('tweets.api.urls', namespace='tweet-api')),
    url(r'^api/', include('account.api.urls', namespace='profiles-api')),
    url(r'^register/$', UserRegisterView.as_view(), name='register'), #/
    url(r'^', include('django.contrib.auth.urls')),
    url(r'^', include('account.urls', namespace='profiles')),
]
